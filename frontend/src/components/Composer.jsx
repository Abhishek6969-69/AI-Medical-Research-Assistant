      ...
      <div className="mb-3 flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[0.96rem] text-white/52">
            Add context to refine the clinical search.
          </p>
        </div>

        <span className="hidden rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-white/45 sm:inline-flex">
          Ready when you are
        </span>
      </div>
